%Import data as a matlab table with fields: T [C], P [kbar], rho of solid, rho of water, sum of weight
%fractions of the non-volatile components

clc, clear
Pfitting            = [16 30]; %set the pressure range for fitting [kbar]
%Load data
data                = load("data_constantT_Thermolab.mat");
